...
\begin{document}
\homework{2}{31 August}

\section{}

\problem{When you get your copy of the Bird book, read chapter 1.}
...
Also, consider the following definition given in class: %
