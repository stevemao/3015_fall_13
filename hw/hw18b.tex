...
\SequentRule{\Gamma,E\cup{}\{\tau=\alpha\rightarrow\beta\}}{\lambda{}x.M : \tau}{\Gamma\backslash{}x \cup\{x:\alpha\}}{M:\beta}{Abs}
...
\SequentRuleTwo{\Gamma,E_1\cup{}E_2}{\spread{M}{x,y}{N}:\tau}{\Gamma,E_1}{M:\alpha\times\beta}{([x:\alpha,y:\beta]{\tt{+\!+}}\Gamma),E_2}{N:\tau}{Spread}
{\hspace{.25in}} where $\alpha$ and $\beta$ are fresh.
\vspace{.125in}\\
...
% comment-start: "\\> "
% comment-end: "\\\\ "
% compile-command: "pdflatex hw18b"
% fill-column:79
% End:
