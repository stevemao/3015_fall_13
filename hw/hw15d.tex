...
\exercise{Write {\tt{Term}} parsers {\tt{pV}} for variables, {\tt{pAbs}} for
abstractions (lambda terms), a parser {\tt{pParenTerm}}for terms enclosed in
...
% comment-column:0
% comment-start: "% "
% compile-command: "pdflatex hw15d"
% fill-column:79
% End:
